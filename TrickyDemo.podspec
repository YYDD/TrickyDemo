#
#  Be sure to run `pod spec lint TrickyDemo.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "YYDD"
  # s.authors            = { "YYDD" => "615689375@qq.com" }
  # s.social_media_url   = "http://twitter.com/YYDD"
